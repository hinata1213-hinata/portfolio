...
<head>
    ...
    <title>ゲーム攻略情報部屋 - 六刻巡旅コミュニティ</title>
    ...
    <script>
        ...
        function goToPostDetail(postId) {
            window.location.href = 'post_detail.php?id=' + postId + '&room_id=2';
        }
        ...
        function updateComments() {
            fetch('get_comments.php?room_id=2')
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
...
<body>
    ...
    <div class="room-container">
        ...
        <div class="room-topic">
            <span class="topic-label">📌 運営からのヒント</span>
            <div class="topic-content">
                六刻巡旅の攻略情報をみんなで共有しましょう！<br>
                エンディング到達のヒントや隠し要素の情報をぜひ教えてください。<br>
                困ったときはここで相談してみてくださいね。
            </div>
        </div>
        ...
        <div class="comments-section">
            ...
            if (isset($_POST['post_comment'])) {
                ...
                if (!$ng_error) {
                    try {
                        ...
                        $sql = 'INSERT INTO room_comments (room_id, name, user_id, content, created_at, parent_id) VALUES (2, :name, :user_id, :content, datetime("now", "localtime"), NULL)';
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <div class="comment-form" style="margin-top: 0; margin-bottom: 30px;">
                    ...
                    <?php endif; ?>
                    <form method="post">
                        <textarea name="content" placeholder="攻略情報や質問を書いてください..." required></textarea>
