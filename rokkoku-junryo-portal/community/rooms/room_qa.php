...
<head>
    ...
    <title>運営Q&A部屋 - 六刻巡旅コミュニティ</title>
    ...
    <script>
        ...
        function goToPostDetail(postId) {
            window.location.href = 'post_detail.php?id=' + postId + '&room_id=4';
        }
        ...
        function updateComments() {
            fetch('get_comments.php?room_id=4')
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
...
<body>
    ...
    <div class="room-container">
        ...
        <div class="room-topic">
            <span class="topic-label">📌 公式からのお知らせ</span>
            <div class="topic-content">
                運営チームに直接質問できる特別な部屋です！<br>
                ゲームや今後の展開について気になることを聞いてみてください。<br>
                みなさんの質問をお待ちしています！
            </div>
        </div>
        ...
        <div class="comments-section">
            ...
            if (isset($_POST['post_comment'])) {
                ...
                if (!$ng_error) {
                    try {
                        ...
                        $sql = 'INSERT INTO room_comments (room_id, name, user_id, content, created_at, parent_id) VALUES (4, :name, :user_id, :content, datetime("now", "localtime"), NULL)';
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <div class="comment-form" style="margin-top: 0; margin-bottom: 30px;">
                    ...
                    <?php endif; ?>
                    <form method="post">
                        <textarea name="content" placeholder="運営への質問を書いてください..." required></textarea>
